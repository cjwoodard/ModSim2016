% FIND_DURATION_OF_DRUNKENNESS  Simulate the alcohol model and find the
%   duration (in hours) that the blood alcohol concentration remains above
%   a given threshold.

function res = find_duration_of_drunkenness(S0, d, k_a, k_e, threshold)
